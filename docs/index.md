...
**Rosetta DBT Studio** is a desktop application that runs directly on your computer. It simplifies data transformation and gives you a visual interface for building, running, and managing projects using [**dbt™ Core**](https://www.getdbt.com/) without the need to use the terminal.
...
- **Raw** — the original unmodified data from your source
- **Staging** — cleaned and standardized data
- **Enhanced** — joined and enriched data
- **Business** — final analysis-ready data for dashboards